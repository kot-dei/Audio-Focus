<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <body>
                <div>
                    <table>
                        <thead>
                            <th>name</th>
                            <th>name of medicament	</th>
                            <th>time after first use</th>
                            <th>patient status</th>
                            <th>id</th>
                        </thead>
                        <tbody>
                            <xsl:apply-templates select="//medicament" mode="head"></xsl:apply-templates>
                        </tbody>
                    </table>
                </div>
    ...
    <xsl:template match="medicament" mode="head">
            ...
            <tr>
                <td>
                    <xsl:value-of select="//patient/@name"></xsl:value-of>
                </td>
                <td>
                    <xsl:value-of select="//med/@name"></xsl:value-of>
                </td>
                <td>
